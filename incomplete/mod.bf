...
# GOAL:
# set 3-reg = 1-reg mod 2-reg
# modulus is 'subtract until the remainder is less than the amount you subtracted'
# so we have to test which of two values is bigger
# how can we do that
